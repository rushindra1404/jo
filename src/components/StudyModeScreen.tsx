  ...
  const getOptionStyle = (key: string) => {
    if (hasAttempted) {
      ...
      if (key === selectedOption && !isCorrectChoice) {
        return 'border-rose-500 bg-rose-50 text-rose-800 dark:bg-rose-950/40 dark:text-rose-355';
      }
    ...
    return 'border-slate-200 dark:border-slate-800 hover:border-slate-300 bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-200';
  };
      ...
      <div className="flex-1 px-4 py-4 overflow-y-auto flex items-center">
        <div className="w-full perspective-1000 min-h-[320px] h-[75svh] max-h-[460px] relative">
          ...
          >
            ...
            {/* Back Card Face (Explanation & Score) */}
            <div
            ...
            >
                ...
                <div className="bg-slate-100 dark:bg-slate-950/20 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 space-y-2.5">
                  ...
                  <div className="text-sm font-semibold flex flex-col gap-1.5">
                    <p className="flex items-center gap-1.5">
                      ...
                      <span className="bg-black/10 dark:bg-white/10 px-2 py-0.5 rounded-lg text-xs font-bold">
                        {selectedOption}
                      </span>
                    </p>
                    <p className="flex items-center gap-1.5">
                      <span className="opacity-75">Correct Answer:</span>
                      <span className="bg-emerald-500 text-white px-2 py-0.5 rounded-lg text-xs font-black">
              ...
              <button
                ...
                className="w-full py-3 mt-4 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-750 text-slate-800 dark:text-slate-200 font-bold rounded-xl text-xs uppercase tracking-widest text-center cursor-pointer active:scale-95 transition-all"
              >
